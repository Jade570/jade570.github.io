var i;
  ...
  $('.1').append('<img class="img1" src="201809/index.png"></img>')
  $('.01').append('<span class="dot1" onclick="currentSlide1(0)"></span>')

for (i = 1; i<=4; i++){
  $('.1').append('<img class="img1" src="201809/'+i+'.jpg"></img>')
  $('.01').append('<span class="dot1" onclick="currentSlide1('+i+')"></span>')
}



$('.2').append('<img class="img2" src="201903/index.png"></img>')
$('.02').append('<span class="dot2" onclick="currentSlide2(0)"></span>')

for (i = 1; i<=2; i++){
$('.2').append('<img class="img2" src="201903/'+i+'.jpg"></img>')
$('.02').append('<span class="dot2" onclick="currentSlide2('+i+')"></span>')
}



$('.3').append('<img class="img3" src="201909/index.png"></img>')
$('.03').append('<span class="dot3" onclick="currentSlide3(0)"></span>')

for (i = 1; i<=3; i++){
$('.3').append('<img class="img3" src="201909/'+i+'.jpg"></img>')
$('.03').append('<span class="dot3" onclick="currentSlide3('+i+')"></span>')
}
